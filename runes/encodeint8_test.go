...
func TestEncodeInt8UsingLowerCaseSymbols(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		actualMostSignificant, actualLeastSignificant := hexadecarunes.EncodeInt8UsingLowerCaseSymbols(test.Value)
...
func TestEncodeInt8UsingUpperCaseSymbols(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		actualMostSignificant, actualLeastSignificant := hexadecarunes.EncodeInt8UsingUpperCaseSymbols(test.Value)
